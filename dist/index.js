...
var Cond = function (_a) {
    ...
    if (typeof condition === "boolean") {
        return jsxRuntime.jsx(jsxRuntime.Fragment, { children: condition ? then : fallback });
    }
    // Проверка для массива cases
    if (Array.isArray(cases)) {
        var matchingCase = cases.find(function (c) { return c.condition; });
        if (matchingCase) {
            return jsxRuntime.jsx(jsxRuntime.Fragment, { children: matchingCase.then });
        }
    }
...
var AsyncCond = function (_a) {
    ...
    if (state === 'empty')
        return jsxRuntime.jsx(jsxRuntime.Fragment, { children: elseComponent });
    return data ? jsxRuntime.jsx(jsxRuntime.Fragment, { children: render(data) }) : null;
};
